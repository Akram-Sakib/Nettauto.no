...
const Employee = () => {
  return (
    <div className="flex border-[#FF9776] border rounded max-w-7xl mx-auto">
      <div className="bg-[#FF9776] py-14 px-2 basis-[4%]">
        <p className="[writing-mode:vertical-lr] text-lg font-medium text-white">
          BEDRIFT
        </p>
      </div>
      <div className="px-6 py-4 space-y-8 basis-[27%] flex flex-col justify-between">
        ...
        <Button className="bg-[#D6F5EC] px-24 py-3 rounded-full h-auto w-auto text-[#008B65]">
          Godta
        </Button>
      </div>
      <div className="px-6 py-4 space-y-8 basis-[27%] flex flex-col justify-between">
        ...
        <Button className="bg-[#FBD2D6] px-24 py-3 rounded-full h-auto w-auto text-[#EE5462]">
          Avslå
        </Button>
      </div>
      <div className="px-6 py-4 space-y-8 basis-[27%] flex flex-col justify-between">
        ...
        <Select>
          <SelectTrigger className="w-[320px] border-[#EEEEEE] rounded-full py-3 h-auto pl-8">
      ...
      <div className="text-right basis-[15%] p-2">
