      ...
      <div className="basis-[80%] p-3">
        ...
        <div className="flex justify-between">
          <div className="space-x-4">
            ...
            <span className="font-roboto text-sm text-navyblue">Bergen</span>
          </div>
          <div className="flex gap-x-4 text-white font-semibold">
            <button className="bg-[#FF003D] w-[118px] h-[42px] rounded">
              + 1000 kr
            </button>
            <button className="bg-[#FF003D] w-[118px] h-[42px] rounded">
              + 1000 kr
          ...
          <div className="flex gap-x-4 items-center">
            ...
            <button className="border-2 p-3 border-[#EBEBEB] text-[#0A0A0A] rounded">
              650 000 kr
            </button>
          </div>
        </div>
