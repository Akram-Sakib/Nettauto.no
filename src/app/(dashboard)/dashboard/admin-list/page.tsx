  ...
  return (
    <ScrollArea className="h-full pl-6 m-10 ">
      <div className="mb-6 space-y-8">
        ...
        <Button className="rounded-full px-8 bg-white space-x-4 font-medium py-2 h-auto group">
          <span className="text-[#0B5F7C] text-base group-hover:text-white">New user</span>
          <PlusCircle className="mr-2 h-7 w-7 text-[#0B5F7C] group-hover:text-white" />
        </Button>
      </div>
