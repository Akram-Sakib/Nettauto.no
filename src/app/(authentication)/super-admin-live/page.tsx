        ...
        <div className="my-10 flex flex-col items-center">
          <div className="flex items-center gap-x-4">
            ...
            <div>
              ...
              <h2 className="text-3xl text-primaryred font-bold">750 000 kr</h2>
            </div>
          </div>
        ...
        <div className="flex justify-center">
          <Tabs defaultValue="account" className="w-[900px]">
            ...
            <TabsContent value="account" className="space-y-6">
              ...
              <div>
                <h4 className="text-xl font-bold text-navyblue">Beskrivelse</h4>
                ...
                <p className="text-[#717171] font-roboto">
                  ...
                  condimentum lacus. Maecenas lobortis ante id egestas placerat.
                  Nullam at ultricies lacus. Nam in nulla consectetur, suscipit
                  mauris eu, fringilla augue. Phasellus gravida, dui quis
                  dignissim tempus, tortor orci tristique leo, ut congue diam
                  ipsum at massa. Pellentesque ut vestibulum erat. Donec a felis
                  eget
                </p>
              </div>
              <div>
